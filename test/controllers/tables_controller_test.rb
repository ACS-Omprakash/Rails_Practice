...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference("Table.count") do
      post tables_url, params: { table: { age: @table.age, fname: @table.fname, lname: @table.lname } }
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { age: @table.age, fname: @table.fname, lname: @table.lname } }
